                ...
                <tbody>
                  @foreach ($admins as $admin)    
                    <tr>
                      ...
                      <td><img class="img-thumbnail" src="{{ asset('storage/' . $admin->user->profile_picture) }}" alt="foto_{{ $admin->user->name }}" width="75"></td>
                      <td class="fw-bold" style="font-size: 13px">{{ $admin->user->name }}</td>
